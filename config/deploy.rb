...
role :web, "groupme1.com"                          # Your HTTP server, Apache/etc
role :app, "groupme1.com"                         # This may be the same as your `Web` server
role :db,  "groupme1.com"   , :primary => true # This is where Rails migrations will run
